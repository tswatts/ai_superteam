...
public interface ProjectServiceAsync {
  ...
  /**
   * @see ProjectService#buildEclipseProject(long, String, String, int)
   */
  void buildEclipseProject(long projectId, String target, String nonce, int buildOption, AsyncCallback<RpcResult> callback);
