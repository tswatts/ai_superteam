...
import com.google.appinventor.client.explorer.commands.DownloadFileCommand;
...
public class DesignToolbar extends Toolbar {
  ...
  private class DownloadJavaFilesAction implements Command {
    @Override
    public void execute(){
      ...
      if (projectRootNode != null) {
        ...
        cmd.startExecuteChain(Tracking.PROJECT_ACTION_DOWNLOAD_JAVA_FILES_YA, projectRootNode);
          }
    }
