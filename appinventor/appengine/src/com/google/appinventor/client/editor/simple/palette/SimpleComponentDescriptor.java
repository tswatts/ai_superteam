...
import com.google.appinventor.client.editor.simple.components.Mocktest;
...
public final class SimpleComponentDescriptor {
  ...
  private static void initBundledImages() {
    ...
    bundledImages.put("images/test.png", images.test());
  ...
  public static MockComponent createMockComponent(String name, SimpleEditor editor) {
    ...
    } else if (name.equals(Mocktest.TYPE)) {
      return new Mocktest(editor);
